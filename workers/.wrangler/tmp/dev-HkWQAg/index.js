...
async function handleStatus(env) {
  ...
  for (const item of list.keys) {
    const state = await env.DEVICES.get(item.name, "json");
    if (!state) continue;
    devices.push({
      ...state,
...
// .wrangler/tmp/bundle-KRSZwR/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-KRSZwR/middleware-loader.entry.ts
